...
folly::dynamic FaissIndexConfig::serialize() const {
  return folly::dynamic::object("algorithm", algorithmName(algorithm))(
      "metric", metricName(metric))("dimension", dimension)("nlist", nlist)(
      "nprobe", nprobe)("pqSubquantizers", pqSubquantizers)("pqBits", pqBits)(
      "hnswM", hnswM)("efConstruction", efConstruction)("efSearch", efSearch);
}
...
void BuildIndexNode::addDetails(std::stringstream& stream) const {
  stream << algorithmName(config_.algorithm) << ", " << embeddingColumn_;
}
...
folly::dynamic BuildIndexNode::serialize() const {
  ...
  obj["embeddingColumn"] = embeddingColumn_;
  obj["clusterColumn"] =
      clusterColumn_ ? folly::dynamic(*clusterColumn_) : folly::dynamic(nullptr);
