  ...
  exec::ExchangeTransportRegistry::global().insert(
      ...
      exec::ExchangeTransportEntry::make<UcxExchangeClient>(
          [](const exec::ExchangeClientContext& context) {
            ...
            // tables instead.
            const auto receivePrefetchBytes = context.queryConfig.get<int64_t>(
                cudf_velox::CudfConfig::kUcxReceivePrefetchBytes, 0);
            VELOX_USER_CHECK_GE(
                receivePrefetchBytes,
                0,
                "{} must not be negative",
                cudf_velox::CudfConfig::kUcxReceivePrefetchBytes);
