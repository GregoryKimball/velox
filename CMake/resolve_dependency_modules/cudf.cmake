...
# rmm commit d602ce9 from 2026-08-15 (includes managed-pool release threshold fix, PR #2512)
set(VELOX_rmm_VERSION 26.10)
set(VELOX_rmm_COMMIT d602ce95f041ec9fb15c58c0c1eb3013ba80f7e2)
set(
  VELOX_rmm_BUILD_SHA256_CHECKSUM
  818ea848ff991a6e21fcb15e2769a1d3b6b864638ac06bac26aee236dbf33c01
)
...
block(SCOPE_FOR VARIABLES)
  ...
  FetchContent_Declare(
    ...
    PATCH_COMMAND
      patch -p1 --forward --input=${CMAKE_CURRENT_LIST_DIR}/kvikio-nvtx-cuda13.patch
    SOURCE_SUBDIR
    cpp
    UPDATE_DISCONNECTED 1
  )
